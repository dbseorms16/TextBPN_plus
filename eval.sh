...
###################### CTW-1500 ####################################
# test_size=(640,1024)--cfglib/option
CUDA_LAUNCH_BLOCKING=1 python3 eval_textBPN.py --iter 5 --num_poly 16 --exp_name Custom --checkepoch 50 --test_size 640 1024 --dis_threshold 0.375 --cls_threshold 0.8 --gpu 7 --viz
