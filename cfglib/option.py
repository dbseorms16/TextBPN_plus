...
class BaseOptions(object):
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--iter', default=3, type=int, help='Number of iteration')
        ...
        self.parser.add_argument('--display_freq', default=11, type=int, help='display training metrics every # iter')
