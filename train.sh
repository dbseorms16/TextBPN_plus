...
python -m torch.distributed.launch --nproc_per_node=8 train_textBPN.py --iter 3 --num_poly 16 --exp_name Custom --net resnet50 --scale 1 --max_epoch 300 --batch_size 45 --mgpu --gpu 0,1,2,3,4,5,6,7 --input_size 640 --optim Adam --lr 0.001 --num_workers 64 --viz --viz_freq 80
